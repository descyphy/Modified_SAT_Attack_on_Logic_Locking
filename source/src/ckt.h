...
namespace ckt_n {
    ...
    struct ckt_t
    {
        ...
        int count_differing_inputs(const char* keys, int MAX_COUNT);
    ...
    private:
        ...
        // helper function in the solver.
        void _solver_set_keys(sat_n::Solver& S, index2lit_map_t& map, const char* key);
